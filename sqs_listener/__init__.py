...
class SqsListener(object):
    ...
    def __init__(self, queue, **kwargs):
        ...
        if len(aws_access_key) != 0 and len(aws_secret_key) != 0:
            ...
            if not os.environ.get("AWS_ACCOUNT_ID", None) and not (
                ...
                in ["sso", "iam-role", "assume-role", "assume-role-with-web-identity"]
            ):
        ...
        self._process_later = kwargs.get("process_later", json.loads)
    ...
    def _initialize_client(self):
        ...
        try:
            ...
            raise EnvironmentError(
                "Error loading SSO Token. Reauthenticate via aws sso login."
            )
